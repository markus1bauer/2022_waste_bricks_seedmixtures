...
environment12 <- environment12 %>%
  mutate(conf.low = c(1:160),
         ...
         f.watering = dplyr::recode(f.watering,
                                    "0.5" = "Dry",
                                    "1" = "Medium_dry",
                                    "2" = "Medium_moist",
                                    "3" = "Moist")
...
write_csv(environment1,
          here("data", "processed",
               "data_processed_experiment_1_environment.csv"))
write_csv(environment2,
          here("data", "processed",
               "data_processed_experiment_2_environment.csv"))
write_csv(environment3,
          here("data", "processed",
               "data_processed_experiment_3_environment.csv"))
